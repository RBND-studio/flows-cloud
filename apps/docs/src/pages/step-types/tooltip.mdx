...
CSS selector of the element that the tooltip should point to. The tooltip will be positioned next to this element and will follow it as it moves. If the target element is not found, the tooltip will not be shown and will wait for the element to appear for up to X minutes, after that the flow will fail and tooltip error will be tracked in the analytics.
