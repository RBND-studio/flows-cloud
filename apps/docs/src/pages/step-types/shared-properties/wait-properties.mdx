...
Wait for an element to appear in the DOM. You can specify the CSS selector of the element that should appear in the DOM before proceeding to the next step. Can be combined with the location property to specify on which URL the element should appear.
