...
After you manage to sucessfully start the demo flow you should see new local flow inside your Flows Cloud project with one start event. If you don't see the flow, please check the browser console for any errors.
