...
When you are developing locally, you don't need to add `localhost` to the list of allowed domains. The Flows SDK will work on your machine without any additional configuration. Note that any events from the local environment will be ignored in the analytics and billing.
