...
Any changes you make to the flow will not be visible to your users until you publish the changes. This allows you to make changes to your flow and test them before they are visible to your users. When you are ready to make your changes live, click `Publish changes`.
